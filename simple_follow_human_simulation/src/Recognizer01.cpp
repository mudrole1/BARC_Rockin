...
int main(int argc, char **argv)
{
  ...
  ros::Publisher  node_pub = n.advertise <follow_sim::Recognizer>("rec", 2); // Humans in the environment
  ros::Subscriber node_sub = n.subscribe("robot_1/base_scan", 2, LaserCallback);

  follow_sim::Recognizer msg; // robot_vel
