...
class NavigateDoor(smach.State):
	...
	def execute(self, userdata):
		...
		msg.goal.target_pose.pose.position.x = 0.51
                msg.goal.target_pose.pose.position.y = 0.17
                msg.goal.target_pose.pose.position.z = 0
                msg.goal.target_pose.pose.orientation.x = 0
   		msg.goal.target_pose.pose.orientation.y = 0
   	        msg.goal.target_pose.pose.orientation.z = 0.84
    		msg.goal.target_pose.pose.orientation.w = 0.54
...
class NavigateEnter(smach.State):
	...
	def execute(self, userdata):
		...
		msg.goal.target_pose.pose.position.x = 0.95
		msg.goal.target_pose.pose.position.y = -0.83
		msg.goal.target_pose.pose.position.z = 0
		msg.goal.target_pose.pose.orientation.x = 0
		msg.goal.target_pose.pose.orientation.y = 0
		msg.goal.target_pose.pose.orientation.z = 0.78
		msg.goal.target_pose.pose.orientation.w = 0.62
...
class NavigateBedroom(smach.State):
	...
	def execute(self, userdata):
		...
		msg.goal.target_pose.pose.position.x = 4.75
		msg.goal.target_pose.pose.position.y = 2.16
		msg.goal.target_pose.pose.position.z = 0
		msg.goal.target_pose.pose.orientation.x = 0
		msg.goal.target_pose.pose.orientation.y = 0
